...
GameManager.prototype.afterPayment = function() {
...
GameManager.prototype.submitTransaction = async function (paymentId, amount, user) {
  var self = this;
  const url = '/api/v1/make-payment/';
  const data = {
    user: user,
...
GameManager.prototype.finalizeTransaction = async function (paymentId, transactionId) {
  var self = this;
